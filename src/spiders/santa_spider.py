...
class SantaSpider(SpiderInterface):
    INFO = {
        "name": SpiderName.SANTA.value,
    ...
    BASE_PAGE_URL = "https://www.santaisabel.cl"
    ...
    async def get_page_urls_by_start_url(self, url: str) -> list[str]:
        ...
        return [f"{url}?sc=1&page={i+1}" for i in range(last_page)]
